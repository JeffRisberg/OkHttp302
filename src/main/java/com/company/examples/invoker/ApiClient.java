...
package com.company.examples.invoker;

import com.company.examples.invoker.auth.ApiKeyAuth;
import com.company.examples.invoker.auth.Authentication;
import com.company.examples.invoker.auth.HttpBasicAuth;
import com.company.examples.invoker.auth.OAuth;
import okhttp3.*;
...
public class ApiClient {
    ...
    private String basePath = "http://localhost/api/v1/incidents";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost/api/v1/incidents
